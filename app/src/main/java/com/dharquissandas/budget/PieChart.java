...
/**
 * Created by Moksh on 12/12/2017.
 */
...
public class PieChart extends ViewGroup {
    ...
    private float mPointerRadius = 0f;
    ...
    public PieChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mPointerRadius = a.getDimension(R.styleable.PieChart_pointerRadius, 0.0f);
    ...
    private void init() {
        ...
        if (this.isInEditMode()) {
            ...
            addItem("Annabelle", 3, res.getColor(R.color.fab2_color));
            addItem("Brunhilde", 4, res.getColor(R.color.colorAccent));
            addItem("Carolina", 2, res.getColor(R.color.fab1_color));
            addItem("Dahlia", 3, res.getColor(R.color.colorPrimaryDark));
            addItem("Ekaterina", 1, res.getColor(R.color.dark_green));
        }
